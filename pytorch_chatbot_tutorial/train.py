...
from data_preparation import batch2TrainData
...
#   process like we must do for the ``decoder`` model. As long as youhidden_size = 500
...
def trainIters(model_name, voc, pairs, encoder, decoder, encoder_optimizer, decoder_optimizer, embedding, encoder_n_layers, decoder_n_layers, save_dir, n_iteration, batch_size, print_every, save_every, clip, corpus_name, loadFilename, checkpoint, max_length, teacher_forcing_ratio, hidden_size):
